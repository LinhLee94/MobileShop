<%-- 
    Document   : Blog
    Created on : Aug 15, 2018, 9:32:23 PM
    Author     : Linhlee
--%>
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/blogmate.css" type="text/css">
...
<link href="https://fonts.googleapis.com/css?family=Roboto:400,500,700" rel="stylesheet" type="text/css">
    ...
    <body>
        <div class="page">
            ...
            <!-- container -->
            <jsp:include page="NL/Container_blog.jsp"></jsp:include>
            <!-- footer --> 
