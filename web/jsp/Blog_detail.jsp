<%-- 
    ...
    Created on : Aug 15, 2018, 10:45:20 PM
    Author     : Linhlee
--%>
...
<link href="https://fonts.googleapis.com/css?family=Roboto:400,500,700" rel="stylesheet" type="text/css">
    ...
    <body>
        <div class="page">
            ...
            <!-- container -->
            <jsp:include page="NL/Container_blog_detail.jsp"></jsp:include>
            <!-- footer -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/cloud-zoom.js"></script>
