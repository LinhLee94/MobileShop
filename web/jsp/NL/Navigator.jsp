<%-- 
    Document   : Navigator
    Created on : Aug 13, 2018, 11:36:57 PM
    Author     : Linhlee
--%>
...
<nav class="">
    <div class="container">
      <div class="nav-inner"> 
        ...
        <!--End mobile-menu --> 
        <a class="logo-small" title="Magento Commerce" href="index.html"><img alt="Magento Commerce" src="${pageContext.request.contextPath}/resources/images/logo-small.png"></a>
            ...
            <div class="level0-wrapper dropdown-6col" style="display:none;">
              <div class="level0-wrapper2">
                <div class="nav-block nav-block-center grid12-8 itemgrid itemgrid-4col">
                  ...
                  <div class="nav-add">
                    <div class="push_item1">
                      <div class="push_img"> <a href="#"> <img alt="women jwellery" src="${pageContext.request.contextPath}/resources/images/women-cate-banner.jpg"> </a> </div>
                    </div>
                    <div class="push_item1">
                      <div class="push_img"> <a href="#"> <img alt="women_jwellery" src="${pageContext.request.contextPath}/resources/images/women-cate-banner1.jpg"> </a> </div>
                    </div>
                    <div class="push_item1 push_item1_last">
                      <div class="push_img"> <a href="#"> <img alt="women_bag" src="${pageContext.request.contextPath}/resources/images/women-cate-banner2.jpg"> </a> </div>
                    </div>
                    <br class="clear">
                  </div>
                </div>
                ...
                <div class="nav-block nav-block-right std grid12-4">
                  <p><a href="#"><img class="fade-on-hover" src="${pageContext.request.contextPath}/resources/images/nav-women-banner.jpg" alt="nav img"></a></p>
                </div>
            ...
            <div class="level0-wrapper dropdown-6col" style="display: none; left: 0px;">
              <div class="level0-wrapper2"> 
                ...
                <div class="nav-block nav-block-left std grid12-6">
                  <p><a href="#"><img class="fade-on-hover" src="${pageContext.request.contextPath}/resources/images/nav-men-banner.jpg" alt="nav img"></a></p>
                </div>
                <!--nav-block nav-block-right std grid12-4-->
                ...
                <div class="nav-block nav-block-center grid12-8 itemgrid itemgrid-4col">
                  ...
                  <div class="nav-add">
                    <div class="push_item">
                      <div class="push_img"> <a href="#"> <img alt="women_jwellery" src="${pageContext.request.contextPath}/resources/images/men-banner-img.jpg"> </a> </div>
                    </div>
                    <div class="push_item last">
                      <div class="push_img"> <a href="#"> <img alt="women_jwellery" src="${pageContext.request.contextPath}/resources/images/men-banner-img1.jpg"> </a> </div>
                    </div>
                    <br class="clear">
                  </div>
                </div>
          ...
          <li class="level0 nav-5 level-top first"> <a class="level-top" href="grid.html"> <span>Electronics</span> </a>
            <div style="display:none;" class="level0-wrapper dropdown-6col">
              <div class="level0-wrapper2">
                <div class="nav-block nav-block-center grid12-8 itemgrid itemgrid-4col"> 
                  ...
                  <ul class="level3">
                    <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>Mobiles</span></a> 
                      ...
                      <!--sub sub category-->
                      <div class="cat-img"><img src="${pageContext.request.contextPath}/resources/images/e-img1.jpg" alt="Mobiles"></div>
                    </li>
                    ...
                    <li class="level1 nav-6-1 parent item"> <a href="grid.html"><span>Mobiles Accesories</span></a> 
                      ...
                      <!--sub sub category-->
                      <div class="cat-img"><img src="${pageContext.request.contextPath}/resources/images/e-img2.jpg" alt="Mobiles Accesories"></div>
                    </li>
                    <!--level1 nav-6-1 parent item-->
                    ...
                    <li class="level1 nav-6-1 parent item"> <a href="grid.html"><span>Cameras</span></a> 
                      ...
                      <!--sub sub category-->
                      <div class="cat-img"><img src="${pageContext.request.contextPath}/resources/images/e-img3.jpg" alt="Cameras"></div>
                    </li>
                    <!--level1 nav-6-1 parent item-->
                    ...
                    <li class="level1 nav-6-1 parent item"> <a href="grid.html"><span>Audio &amp; Video</span></a> 
                      ...
                      <!--level1--> 
                      <!--sub sub category-->
                      <div class="cat-img"><img src="${pageContext.request.contextPath}/resources/images/e-img4.jpg" alt="Audio &amp; Video"></div>
                    </li>
                    <!--level1 nav-6-1 parent item-->
                  </ul>
                  <!--level0--> 
                ...
                <!--nav-block nav-block-center-->
                <div class="nav-block nav-block-right std grid12-4">
                  <p><a href="#"><img class="fade-on-hover" src="${pageContext.request.contextPath}/resources/images/nav-img1.jpg" alt="nav img"></a></p>
          ...
          <li class="nav-custom-link level0 level-top parent"> <a class="level-top" href="#"><span>Custom</span></a>
            <div class="level0-wrapper custom-menu" style="left: 0px; display: none;">
              <div class="header-nav-dropdown-wrapper clearer">
                <div class="grid12-5">
                  <div class="custom_img"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/custom-img1.jpg" alt="custom img1"></a></div>
                ...
                <div class="grid12-5">
                  <div class="custom_img"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/custom-img2.jpg" alt="custom img2"></a></div>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
                  <button class="learn_more_btn" title="Add to Cart" type="button"><span>Learn More</span></button>
                </div>
                <div class="grid12-5">
                  <div class="custom_img"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/custom-img3.jpg" alt="custom img3"></a></div>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
                  <button class="learn_more_btn" title="Add to Cart" type="button"><span>Learn More</span></button>
                </div>
                <div class="grid12-5">
                  <div class="custom_img"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/custom-img4.jpg" alt="custom img4"></a></div>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
                  <button class="learn_more_btn" title="Add to Cart" type="button"><span>Learn More</span></button>
                </div>
              </div>
