<%-- 
    Document   : Container_list
    Created on : Aug 14, 2018, 9:16:22 PM
    Author     : Linhlee
--%>
      ...
      <div class="row">
        <section class="col-main col-sm-9 col-xs-12 col-sm-push-3 wow">
          ...
          <div class="category-description std">
            <div class="category-image"><img src="${pageContext.request.contextPath}/resources/images/category-banner-img.jpg" alt="cat imges " title="Sofas "> </div>
          </div>
          <div class="category-products">
            ...
            <ul id="products-list" class="products-list">
              <li class="item odd">
                <div class="col-item">
                  <div class="product_image">
                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img src="${pageContext.request.contextPath}/resources/products-images/product1.jpg" class="img-responsive" alt="a"> </a>
              ...
              <li class="item even">
                <div class="col-item">
                  <div class="product_image">
                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img src="${pageContext.request.contextPath}/resources/products-images/product2.jpg" class="img-responsive" alt="a"> </a>
                      <div class="qv-button-container"> <a class="qv-e-button btn-quickview-1" href="quick_view.html"><span><span>Quick View</span></span></a> </div>
                    </div>
                  </div>
                  <div class="product-shop">
              ...
              <li class="item odd">
                <div class="col-item">
                  <div class="product_image">
                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img src="${pageContext.request.contextPath}/resources/products-images/product3.jpg" class="img-responsive" alt="a"> </a>
                      <div class="qv-button-container"> <a class="qv-e-button btn-quickview-1" href="quick_view.html"><span><span>Quick View</span></span></a> </div>
                    </div>
                  </div>
                  <div class="product-shop">
              ...
              <li class="item even">
                <div class="col-item">
                  <div class="product_image">
                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img src="${pageContext.request.contextPath}/resources/products-images/product4.jpg" class="img-responsive" alt="a"> </a>
                      <div class="qv-button-container"> <a class="qv-e-button btn-quickview-1" href="quick_view.html"><span><span>Quick View</span></span></a> </div>
                    </div>
                  </div>
                  <div class="product-shop">
              ...
              <li class="item odd">
                <div class="col-item">
                  <div class="product_image">
                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img src="${pageContext.request.contextPath}/resources/products-images/product5.jpg" class="img-responsive" alt="a"> </a>
                      <div class="qv-button-container"> <a class="qv-e-button btn-quickview-1" href="quick_view.html"><span><span>Quick View</span></span></a> </div>
                    </div>
                  </div>
                  <div class="product-shop">
              ...
              <li class="item even">
                <div class="col-item">
                  <div class="product_image">
                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img src="${pageContext.request.contextPath}/resources/products-images/product6.jpg" class="img-responsive" alt="a"> </a>
                      <div class="qv-button-container"> <a class="qv-e-button btn-quickview-1" href="quick_view.html"><span><span>Quick View</span></span></a> </div>
                    </div>
                  </div>
                  <div class="product-shop">
              ...
              <li class="item odd">
                <div class="col-item">
                  <div class="product_image">
                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img src="${pageContext.request.contextPath}/resources/products-images/product7.jpg" class="img-responsive" alt="a"> </a>
                      <div class="qv-button-container"> <a class="qv-e-button btn-quickview-1" href="quick_view.html"><span><span>Quick View</span></span></a> </div>
                    </div>
                  </div>
                  <div class="product-shop">
              ...
              <li class="item even">
                <div class="col-item">
                  <div class="product_image">
                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img src="${pageContext.request.contextPath}/resources/products-images/product8.jpg" class="img-responsive" alt="a"> </a>
                      <div class="qv-button-container"> <a class="qv-e-button btn-quickview-1" href="quick_view.html"><span><span>Quick View</span></span></a> </div>
                    </div>
                  </div>
                  <div class="product-shop">
              ...
              <li class="item odd">
                <div class="col-item">
                  <div class="product_image">
                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img src="${pageContext.request.contextPath}/resources/products-images/product9.jpg" class="img-responsive" alt="a"> </a>
                      <div class="qv-button-container"> <a class="qv-e-button btn-quickview-1" href="quick_view.html"><span><span>Quick View</span></span></a> </div>
                    </div>
                  </div>
                  <div class="product-shop">
              ...
              <li class="item last even">
                <div class="col-item">
                  <div class="product_image">
                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img src="${pageContext.request.contextPath}/resources/products-images/product10.jpg" class="img-responsive" alt="a"> </a>
                      <div class="qv-button-container"> <a class="qv-e-button btn-quickview-1" href="quick_view.html"><span><span>Quick View</span></span></a> </div>
                    </div>
                  </div>
                  <div class="product-shop">
        ...
        <aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9 wow">
          ...
          <div class="block block-cart">
            ...
            <div class="block-content">
              ...
              <ul>
                <li class="item"> <a class="product-image" title="Fisher-Price Bubble Mower" href="#"><img width="80" alt="Fisher-Price Bubble Mower" src="${pageContext.request.contextPath}/resources/products-images/p1.jpg"></a>
                ...
                <li class="item last"> <a class="product-image" title="Prince Lionheart Jumbo Toy Hammock" href="#"><img width="80" alt="Prince Lionheart Jumbo Toy Hammock" src="${pageContext.request.contextPath}/resources/products-images/p48.jpg"></a>
                  <div class="product-details">
                    <div class="access"> <a class="btn-remove1" title="Remove This Item" href="#"> <span class="icon"></span> Remove </a> </div>
          ...
          <div class="block block-banner"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/block-banner.png" alt="block-banner"></a></div>
        </aside>
      </div>
    </div>
  </section>