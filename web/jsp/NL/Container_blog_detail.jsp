<%-- 
    Document   : Container_blog_detail
    Created on : Aug 15, 2018, 10:44:35 PM
    Author     : Linhlee
--%>
              ...
              <div role="main" id="content">
                <article class="blog_entry clearfix" id="post-29">
                  ...
                  <div class="entry-content">
                    <div class="featured-thumb"><a href="#"><img alt="blog-img4" src="${pageContext.request.contextPath}/resources/images/blog-img4.jpg"></a></div>
                    <div class="entry-content">
                    ...
                    <ul class="commentlist">
                      <li class="comment">
                        <div class="comment-wrapper" id="post-29">
                          <div class="comment-author vcard"> <p class="gravatar"><a href="#"><img width="60" height="60" alt="avatar" src="${pageContext.request.contextPath}/resources/images/avatar60x60.jpg"></a></p><span class="author">John Doe</span> </div>
                      ...
                      <li class="comment">
                        <div class="comment-wrapper" id="post-29">
                          <div class="comment-author vcard"><p class="gravatar"><a href="#"><img width="60" height="60" alt="avatar" src="${pageContext.request.contextPath}/resources/images/avatar60x60.jpg"></a></p> <span class="author">Lisa White</span> </div>
                          <!--comment-author vcard-->
                          <div class="comment-meta">
